...
<div class="tab-content">
    ...
    <input type="text" class="form-control" id="product_name" placeholder="Rechercher le produit">
    </div>
    </div>
    <div class="col-sm-6">
...
<div class="col-sm-12 col-md-6">
      <form class="form-inline mb-3">
            ...
            <input type="text" id="add_item" class="form-control" placeholder="Scanner Barcode ou QR-code ici">
            </div>
            <div class="form-group">
            <label class="mr-3 ml-3">Ou</label>
            </div>
            <div class="form-group">
            <input type="text" class="form-control" id="add_item_m" placeholder="Entrez manuel du code Barre">
            </div>
      </form>
...
<input type="button" id="full_paid_tab" class="btn btn-warning btn-lg mr-2" value="<?php echo display('full_paid')?>" tabindex="14" onClick="full_paid()"/>
<input type="submit" id="add_invoice" class="btn btn-success btn-lg mr-2" name="add_invoice" value="Ticket">
