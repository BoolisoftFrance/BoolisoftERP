                ...
                <table class="table table-striped" border="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php } else { ?>
                                <td align="right"><?php echo (($position == 0) ? ' '.$details['discount_per'] : $details['discount_per'].' '. $currency) ?></td>
                            <?php } ?>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td align="right" ><b><?php echo (($position == 0) ? ' '.$subTotal_ammount  : $subTotal_ammount.' '. $currency) ?></b></td>
                        </tr>
                    </tbody>
